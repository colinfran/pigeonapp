import React__default, { createElement, PureComponent, Component } from 'react';
...
function copyRefs(TargetComponent, SourceComponent) {
  ...
  Object.getOwnPropertyNames(SourceComponent.prototype).filter(function (prop) {
    ...
    prop in Component.prototype || // Properties from React's prototype such as `setState`
    // $FlowFixMe
          ...
          return createElement(
            ...
            function (theme) {
              ...
              if (isClassComponent(Comp)) {
                ...
                element = createElement(Comp, _extends({}, rest, {
                  ref: function ref(c) {
                    _this2._root = c;
                  },
                  theme: merged
                ...
                element = createElement(Comp, _extends({}, rest, { theme: merged }));
              }
