...
class SettingsList extends React.Component {
  ...
  _itemView(item, index, max){
    ...
    return (
      <TouchableOpacity accessible={false} key={'item_' + index} underlayColor={item.underlayColor ? item.underlayColor : this.props.underlayColor} onPress={item.onPress} onLongPress={item.onLongPress} ref={item.itemRef}>
